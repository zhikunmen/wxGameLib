...
declare var wx: {
    ...
    */
    ...
    openCustomerServiceConversation(obj: {
        ...
        showMessageCard?: boolean,//是否显示会话内消息卡片默认false
        sendMessageTitle?: string,//会话内消息卡片标题
        sendMessagePath?: string,//会话内消息卡片路径	
        sendMessageImg?: string,//会话内消息卡片图片路径
        success?: Function,
        fail?: Function,
        complete?: Function
    })
    ...
    requestMidasPayment(obj: {
        mode: string,//支付的类型 唯一可选值:game
        env?: number,//环境配置默认0  0米大师正式环境1米大师沙箱环境
        offerId: string,//在米大师侧申请的应用 id	
        currencyType: string,//币种
        platform?: string,//申请接入时的平台，暂只支持android
        buyQuantity?: number,//购买数量。mode=game 时必填
        zoneId?: number,//分区 ID
        success?: Function,
        fail?: Function,
        complete?: Function
